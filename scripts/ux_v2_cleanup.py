...
# 1) Importa a configuração de navegação isolada do app principal.
...
# 2) Remove os grandes dicionários de navegação duplicados que estavam dentro de app.py.
...
# 3) Atualiza o renderizador para usar o módulo novo.
